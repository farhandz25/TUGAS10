    ...
    <div class="container">
      ...
      <div class="cart-container">
        ...
        <div class="empty-cart" v-else>
          ...
          <p>Mulai belanja sekarang dan temukan produk terbaik untuk Anda</p>
...
.cart-page {
  padding: 40px 0;
  /* Menggunakan warna latar belakang global dari tema gelap */
...
.cart-items {
  flex: 2;
  /* Menggunakan warna permukaan kartu */

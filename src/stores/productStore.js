...
export const useProductStore = defineStore('products', {
  state: () => ({
    ...
    featuredProducts: [],
    categories: [
      { id: 'mod', name: 'Mod/AIO', image: '/images/mod-category.jpg' },
      { id: 'pod', name: 'Pod System', image: '/images/pod-category.jpg' },
      { id: 'liquid', name: 'E-Liquid', image: '/images/liquid-category.jpg' }
    ],
    isLoading: false,
    error: null
  }),

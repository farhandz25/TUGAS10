      ...
      <div class="container">
        <div class="header-content">
          <router-link to="/" class="logo">
            <img src="@/assets/images/logo.png" alt="VapeStore" class="logo-img" />
            <span class="logo-text">VapeStore</span>
          </router-link>
      ...
      <div class="container">
        <div class="footer-grid">
          <div class="footer-col">
            <h3 class="footer-title">VapeStore</h3>
            <p class="footer-about">
              Toko vape online terpercaya dengan koleksi terlengkap dan harga terbaik.
            </p>
        ...
        <div class="footer-bottom">
          <p>&copy; {{ new Date().getFullYear() }} VapeStore. All rights reserved.</p>
